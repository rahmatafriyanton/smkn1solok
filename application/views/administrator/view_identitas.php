    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Email</th>                        <td><input type='text' class='form-control' name='b' value='$record[email]'></td></tr>
                    <tr><th scope='row'>Domain</th>                 <td><input type='text' class='form-control' name='c' value='$record[url]'></td></tr>
                    ...
                    <tr><th scope='row'>Google Maps</th>                  <td><textarea class='form-control' name='j' style='height:80px'>$record[maps]</textarea></td></tr>
                    <tr><th scope='row'>Favicon</th>                      <td><input type='file' class='form-control' name='i' value='$record[favicon]'></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
